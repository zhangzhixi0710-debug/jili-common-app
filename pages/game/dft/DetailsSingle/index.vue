<template>
    <div class="single-container single">
        ...
        <div class="single-images">
            ...
            <MultipleDetail
                v-if="(RoundQueue.rounds && RoundQueue.rounds.plates && RoundQueue.rounds.plates.length)"
                v-for="(item, key) in (RoundQueue.rounds && RoundQueue.rounds.plates)"
                :isFreeGame="isFreeGame"
                :key="item.uuid"
                :uuid="item.uuid"
                :config="item"
                :keyValue="key"
                :total="(RoundQueue.rounds && RoundQueue.rounds.plates && RoundQueue.rounds.plates.length)"
            />
        </div>
