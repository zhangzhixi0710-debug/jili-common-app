        ...
        <div v-for="(item, index) in config.rounds" :key="index">
            ...
            <template v-if="item.PlateSymbolExtend">
                <div class="single-images-contain">
                    <div class="single-images-middle" v-if="(item.PlateSymbolExtend && item.PlateSymbolExtend.length)">
                        <div
            ...
            <template v-if="isFreeGame">
                <div class="single-images-event" v-if="(config && config.rounds && config.rounds.length) - 1 === index">
