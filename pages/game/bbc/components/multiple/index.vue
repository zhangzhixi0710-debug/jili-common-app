        ...
        <template v-if="config.PlateSymbolExtend">
            <div class="single-images-contain">
                ...
                <div
                    ...
                    v-if="(config.PlateSymbolExtend && config.PlateSymbolExtend.length)"
                >
                    <div
                    ...
                    <div class="single-images-active-header" v-if="showHeader(config.uuid)">
                        <span v-if="(changeList[config.uuid] && changeList[config.uuid].Money)">{{
                ...
                <!-- 下方选项按钮 -->
                <div class="single-images-footer" v-if="(config.AwardDataVec && config.AwardDataVec.length)">
                    <div
